        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    ...
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: akshaykumar625@yahoo.in<br>
                        <span class="glyphicon glyphicon-link"></span> Facebook: <a href="https://www.facebook.com/">Contact on Facebook</a><br>
                        <span class="glyphicon glyphicon-phone"></span> Mobile: +917991093430
                    </p>
                </div>
                <div class="col-md-6">
                    <form>
